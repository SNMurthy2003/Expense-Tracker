...
const TeamNameDisplay = styled.span`
  font-size: 1rem;
  font-weight: 700;
  color: #4f46e5;
  flex: 1;
...
// Smooth and Simple Animation Variants
...
// Custom category slide-down animation
...
const AddExpenseModal = ({ show, onClose, onAddExpense, preselectedTeam = '' }) => {
  ...
  const handleSubmit = () => {
    ...
    // Prepare data - use custom category if "Other" is selected
        ...
        <ModalPortal>
          ...
          >
            ...
            <AnimatePresence mode="wait">
              {formData.category === 'Other' && (
                ...
                >
                  ...
                  <Input
                    type="text"
                    placeholder="Enter custom category (e.g., Pet Care, Education) *"
            ...
            <TeamDisplay>
              ...
              <TeamNameDisplay>{preselectedTeam || 'No team selected'}</TeamNameDisplay>
            </TeamDisplay>
