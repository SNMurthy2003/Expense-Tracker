...
// src/components/EditIncomeModal.js
...
const EditIncomeModal = ({ show, onClose, onEditIncome, income }) => {
  ...
  useEffect(() => {
    if (income) {
      const isCustomCategory = !['Salary', 'Freelance', 'Investment', 'Business'].includes(income.category);
      setFormData({
        title: income.title || '',
        amount: income.amount || '',
        category: isCustomCategory ? 'Other' : income.category || 'Salary',
